...
public class PresentationClassB extends AppCompatActivity {
    ...
    class LoadQuestion extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... params){
            ...
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (16, 'Frenando fuerte, poniendo la palanca de cambio en neutro y tirando el freno de mano justo antes de detenerse', 0, 6)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (17, 'Frenando suavemente, presionando el pedal de embrague y tirando el freno de mano justo antes de detenerse.', 0, 6)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (18, 'Frenando suavemente, luego un poco más fuerte cuando comienza a detenerse y después aflojando de a poco el freno antes de detenerse', 1, 6)");
            db.execSQL("INSERT INTO questions (_id, question, image) values (7, '¿Cuándo puede usted hacer sonar la bocina de su auto?','')");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (19, 'Para que le cedan el paso.', 0, 7)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (20, 'Para prevenir la ocurrencia de un accidente', 1, 7)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (21, 'Para llamar la atención de un amigo', 0, 7)");
            ...
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (22, 'Usando el freno de mano si las ruedas comienzan a resbalar.', 0, 8)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (23, 'Conduciendo a una velocidad baja en el cambio más alto posible.', 1, 8)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (24, 'Conduciendo en un cambio bajo todo el tiempo.', 0, 8)");
            ...
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (25, 'Cuando esté retrocediendo en una calle de poco tránsito.', 0, 9)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (26, 'Cuando esté en pana y obstaculizando el tránsito.', 1, 9)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (27, 'Cuando esté en pana moviéndose lentamente', 0, 9)");
            ...
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (28, '18 Y 29 AÑOS.', 1, 10)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (29, '30 Y 40 AÑOS.', 0, 10)");
            db.execSQL("INSERT INTO alternatives (_id, alternative, rigth, questions_id) values (30, '40 Y 49 AÑOS.', 0, 10)");
            return null;
        }
        @Override
